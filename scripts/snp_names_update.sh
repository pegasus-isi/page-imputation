...
plink --bfile $file --update-map dbSNP_rs_lifted.out --update-name --make-bed --out TEMP1
...
plink --bfile TEMP1 --update-map temp2.out --update-name --make-bed --out TEMP2
...
plink --bfile TEMP4 --exclude temp3.out --make-bed --out $study
