...
if [ $# -eq 5 ];then
	...
	count=$(awk -v d1="$CHUNK_START" -v d2="$CHUNK_END" '{if (($3 >=d1 )&&($3<=d2)) print $0}' ${STUDY_NAME}.phase.chr${CHR}.haps | wc -l)
        ...
        then
                ...
                echo "No SNP in this chunk; impute2 skipped this chunk" > ${STUDY_NAME}.chr${CHR}.pos${CHUNK_START}-${CHUNK_END}.impute2_summary
